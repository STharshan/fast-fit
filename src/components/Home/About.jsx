...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Salhouse Road Branch, Norwich. Needed a tyre urgently due to large hole in run flat. Not stocked but kindly sourced while I drove to fast fit. Great service. Very quick and friendly. Good price too. Would highly recommend.",
    name: "David Appleby",
  },
