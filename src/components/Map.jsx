...
export default function UKMapInteractive() {
    ...
    const [selectedCity, setSelectedCity] = useState("arbury_cambridge");
        ...
        html: `<div style="font-size: 24px; color: #FF5733;">${<FaMapMarkerAlt />}</div>`, // Customize icon color and size
        iconSize: [30, 30], // Set size of the marker
    });
  ...
  return (
    <section className="w-full py-1 mb-10 bg-white dark:bg-[#0C1416] transition-colors mt-24 relative z-0">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        {/* ✅ RIGHT PANEL - MAP */}
        <div className="rounded-2xl overflow-hidden shadow-sm relative z-0">
          <MapContainer
            ...
            style={{
              ...
              width: "100%",
              position: "relative",
              zIndex: 0, // ✅ prevent overlapping navbar
            }}
          >
            <TileLayer
      ...
      {/* ✅ Ensure map panes don’t overlap other elements */}
      <style jsx global>{`
        .leaflet-pane,
        .leaflet-tile,
        .leaflet-marker-icon,
